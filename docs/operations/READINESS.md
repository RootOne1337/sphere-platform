...
Текущий стенд обновлён до `03b161e`; LATEST указывает на 1.2.7.
...
Backend **`12249b1`**, предшествующий текущему `03b161e`, исправил HTTP 500 после создания script и после
