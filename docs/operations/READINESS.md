...
**Текущая работа — AUD-126:** при нескольких просмотрах одного Android первое
окно теряло кадры без закрытия WebSocket. Дефект воспроизведён на обоих APK;
исправление прошло 112 связанных tests. Установка и повторная native-приёмка
ожидаются. [Доказательства и контракт viewers](../audits/2026-09-05/STREAM-MULTI-VIEWER.md).
