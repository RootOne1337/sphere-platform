...
автовосстановление unhealthy connector (AUD-122, 42 tests pass); независимые отказы
Android/сервера/обоих и возврат стрима требуют отдельной runtime-приёмки.
