...
Source fix и локальная OTA не закрывают удалённую приёмку.
...
| F32-29 | P0, первый кадр / High / R, 23 сентября | UI полагался на одноразовый IDR; source fix добавил повторы, удалённая приёмка OPEN |
