...
Текущий Quick Tunnel — только временный канал без SLA; [проверка F32-20](../2026-09-23/REMOTE-FLEET-LIVE-AUDIT.md)
не доказала, что именно он потерял IDR, но требует независимой WAN-приёмки до
32 одновременных видео.
