...
Повторная проверка **180 s**: 27/27 опросов обоих PID/online, **54/54 echo**,
по одному start на устройство, автоматическое освобождение projection. Поздний
crash-buffer check не содержит новых падений после OTA: последние SIGSEGV — на
предыдущей 1.2.4. После остановки PSS 56,448 / 61,589 KiB, Graphics 0 KiB —
один снимок памяти, не доказательство отсутствия утечки под длительной нагрузкой.
[Подробные samples](evidence/stream-idle-native-180s.json).
