...
и гарантированной доставки каждого сообщения. Reader смешивал смещение в bytes
с пропуском символов через Reader. [AUD-100](APK-UTF8-LOG-TAIL.md) воспроизводит
пустой ответ на установленной APK и исправляет чтение с production-class regression;
статус установки учитывается отдельно. В самом AUD-98 reader не изменялся.
