...
**Текущую очередность перед 32 эмуляторами задаёт [Fleet32 preflight](../2026-09-20/FLEET32-PREFLIGHT.md).**
...
Для scheduler fix сохранено отдельное [RLS evidence](../2026-09-20/evidence/scheduler-rls.json):
