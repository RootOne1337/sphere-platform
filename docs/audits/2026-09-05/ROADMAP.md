...
| 1 | VPN | Device ownership, повтор с исходным PSK и отказ revoke при неясном DELETE исправлены; дубли IP/reinit остаются | Долговечная глобальная lease до router effects, уникальность в PostgreSQL, reconciliation после lost response/Redis loss, commit/release atomicity, AWG/маршруты |
