...
**Дополнение 12 сентября: AUD-89.** Первая APK registration игнорировала заданный
резерв при недоступности основного endpoint. Три новых сценария падали до fix;
targeted 63 проходят после. [Причина, воспроизведение и ограничения](CONNECTION-RECOVERY.md).
