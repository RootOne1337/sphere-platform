...
3 failing regressions → 112 связанных tests passed; установка и повторная native
приёмка пока ожидаются. [Причина, воспроизведение и границы](STREAM-MULTI-VIEWER.md).
