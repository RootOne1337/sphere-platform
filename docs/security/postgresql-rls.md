...
Обновлено 10 сентября 2026. Политики схемы исправлены в
`20260908_tenant_policies`; head теперь `20260910_device_refresh_retry`. **Полный переход приложения на runtime-роль ещё
