...
**Уточнение от 20 сентября:** владелец задал 32 одновременно видимых экрана
(64 — следующий рубеж) и будущие наблюдения около 2fps/device. Актуальные проблемы
timestamp/backpressure, профиль нагрузки, observation/action contract и критерии
измерения описаны в [Fleet32 preflight](../audits/2026-09-20/FLEET32-PREFLIGHT.md).
Это уточнение требований к транспорту; inference и интеграция моделей не реализованы.
