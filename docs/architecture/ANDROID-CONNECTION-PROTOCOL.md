...
AUD-73 исправляет [существующий HTTP discovery](ANDROID-DISCOVERY-RECOVERY.md):
публичный запрос, cancellation и fencing позднего ответа. Автоматический выбор
сохранённого secondary endpoint остаётся отдельной задачей.
