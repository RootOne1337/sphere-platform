        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-[100] flex items-start justify-center pt-[15vh]">
            <div className="w-full max-w-2xl bg-card border border-border rounded-sm shadow-2xl overflow-hidden relative min-h-[400px]">
                ...
                <div className={`absolute inset-0 transition-transform duration-300 ${activeMenu === "main" ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    >
                        <div className="flex items-center border-b border-border px-3 font-mono shrink-0 h-[49px]">
                            ...
                            />
                            <div className="text-[10px] text-muted-foreground bg-border px-1.5 py-0.5 rounded-sm">ESC</div>
                        </div>
                        ...
                        <Command.List className="flex-1 overflow-y-auto custom-scrollbar p-2">
                            ...
                            <Command.Group heading="Navigation" className="text-xs font-mono text-muted-foreground px-2 py-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:font-semibold">
                                <Command.Item
                                    ...
                                    className="flex items-center px-2 py-2 text-sm text-foreground hover:bg-secondary hover:text-primary cursor-pointer rounded-sm mb-1 aria-selected:bg-secondary aria-selected:text-primary transition-colors"
                                >
                            ...
                            <Command.Group heading="Quick Actions" className="text-xs font-mono text-muted-foreground px-2 py-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:font-semibold mt-2">
                                ...
                                <Command.Item
                                    ...
                                    className="flex items-center px-2 py-2 text-sm text-foreground hover:bg-secondary hover:text-primary cursor-pointer rounded-sm aria-selected:bg-secondary aria-selected:text-primary transition-colors"
                                >
                ...
                {/* Меню настройки тем */}
                <div className={`absolute inset-0 bg-card transition-transform duration-300 overflow-y-auto custom-scrollbar ${activeMenu === "themes" ? "translate-x-0" : "translate-x-full"}`}>
                    <div className="sticky top-0 bg-card border-b border-border z-10 flex items-center px-4 py-3 cursor-pointer hover:text-primary transition-colors" onClick={() => setActiveMenu("main")}>
