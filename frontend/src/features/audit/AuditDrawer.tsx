...
export function AuditDrawer({ event, onClose }: AuditDrawerProps) {
    ...
    return (
        <div className="absolute top-0 right-0 w-[500px] h-full bg-[#0A0A0A] border-l border-[#222] shadow-2xl z-40 flex flex-col transform transition-transform duration-300">

            {/* Drawer Header */}
            <div className="px-5 py-4 border-b border-[#222] bg-[#111] flex items-center justify-between shrink-0">
                ...
                <button onClick={onClose} className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-[#222] rounded-sm transition-colors">
                    <X className="w-4 h-4" />
                </button>
            </div>
            ...
            <div className="flex-1 overflow-auto custom-scrollbar p-5 space-y-6">
                ...
                {/* Metadata Section */}
                <div className="grid grid-cols-2 gap-4 border border-[#222] rounded-sm p-4 bg-black/40">
                    <div>
                    ...
                    <div>
                        ...
                        <Badge variant="outline" className="text-[10px] border-[#333] mt-1">{event.action}</Badge>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div className="bg-[#111] border border-[#222] rounded-sm p-4 overflow-x-auto relative group">
