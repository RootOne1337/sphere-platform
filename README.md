...
> **Сейчас идёт повторный восьмичасовой прогон** на двух APK 1.2.7, до ~11:04
> 20 сентября по Екатеринбургу. Предварительная проверка прошла; результат ночи
> пока не принят. [Программа и статус запуска](docs/operations/ANDROID-OVERNIGHT-SOAK.md).
