...
> **Состояние на 13 сентября 2026:** активная разработка и эксплуатационный аудит.
...
> [Текущая APK `8d93e48`, 1.2.2-dev](docs/operations/LOCAL-PILOT.md#apk-именно-для-нового-стенда)
...
> после падения процесса — 5.5 s. OTA self-install, передача кадров между workers
> и VPN пока не приняты целиком.
