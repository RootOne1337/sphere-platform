...
> **Состояние на 14 сентября 2026:** активная разработка и эксплуатационный аудит.
...
> Два LDPlayer проверены одновременно: разные device IDs, правильные команды и
...
> [Текущая APK `343c6e8`, 1.2.5-dev](docs/operations/LOCAL-PILOT.md#apk-именно-для-нового-стенда)
...
> [Падение при захвате экрана исправлено](docs/audits/2026-09-05/ANDROID-CAPTURE-LIFECYCLE.md):
> оба APK обновились через OTA до 1.2.5; 10 циклов захвата с движением экрана,
> сменой зрителя и автоматической остановкой прошли без смены PID.
