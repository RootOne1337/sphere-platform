...
> **Исторический план:** кодовые фрагменты в этом файле не являются актуальным API-контрактом
> и могут содержать незавершённые примеры. Для текущего поведения и подтверждённых ограничений
> см. [Fleet Matrix guide](../../docs/web-ui-guide.md#4-fleet-matrix--управление-устройствами),
> [generated API catalog](../../docs/api-endpoints.md) и
> [audit dated 2026-09-25](../../docs/audits/2026-09-25/FLEET-MATRIX-BULK-ACTIONS.md).
